...
// CELLSCOPE: srsue/hdr/stack/mac/proc_ra.h include removed — unused here and it
// drags in the full srsUE MAC stack. RAR parsing uses srsran::rar_pdu directly.
...
// CELLSCOPE: rrc_utils.h include removed — unused here and pulls in srsenb/*.
