...
#ifdef SRSRAN_STATIC // CELLSCOPE: vendored as a static lib -> no import/export decoration
#define SRSRAN_API
#elif defined(SRSRAN_DLL_EXPORTS) // defined if we are building the SRSRAN DLL (instead of using it)
